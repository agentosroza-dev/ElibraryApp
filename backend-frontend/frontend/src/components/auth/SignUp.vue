...
import {postSignUp} from "@/functions/api/auth.js";
import {useRouter} from "vue-router";

const router = useRouter();

//shallowReactive : data not working in obj in obj
...
async function signup() {
    ...
    try {
        ...
        //check error internet or error syntax
        /*if(!error.response){
           return  console.error("network error or client error");
        }
